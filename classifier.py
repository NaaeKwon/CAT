...
train = pd.read_csv('./data/final_multi/am_train_df.csv', encoding='utf-8', index_col=False)
val = pd.read_csv('./data/final_multi/am_valid_df.csv', encoding='utf-8', index_col=False)
...
for epoch in range(epochs):
    ...
    createDirectory('./model/classifier/')
    torch.save(classifier.state_dict(), './model/classifier/classifier.pt') 
