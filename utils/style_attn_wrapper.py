...
def style_attn_train(args, train_df, valid_df, model, style_optimizer, optimizer, style_scheduler, scheduler, tokenizer):
    loss_plot = input("Style Attention Loss File Name: ")
    loss_plot_path = './style_attn_{}.png'.format(loss_plot)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), './Style_Attn_{}.pt'.format(epoch+1))
...
def style_attn_test(model, sen_sep, sen_label, attention_mask, tokenizer, classifier, max_len=64):
